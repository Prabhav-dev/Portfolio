...
* **Layout Polish:** Refined the About page timeline and canvas architecture for better vertical spacing, visual readability, and fluid scrolling performance.

## Tech Stack
* **Frontend:** HTML5, CSS3, JavaScript, Canvas API, Boxicons, ScrollReveal
* **Core Focus:** Distributed Systems, Low-Level Infrastructure, Backend Architecture, and Hardware-Software Co-Design